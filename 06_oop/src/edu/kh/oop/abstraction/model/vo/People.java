...
public class People {// 국민(사람) 클래스
	...
	// ->직접접근 못하기 때문
	// 클래스 내부에서 간접 접근 방법을 제공하는 기능(메서드)
	// 작성하여 사용한다
	// ->getter/setter
	...
	private String name;// 이름 (직접접근 막음)
	private char gender;// 성병
	private String pNo;// 주민등록번호
	private String address;// 주소
	private String phone;// 전화번호
	private int age;// 나이

	// double bitcoin; // 모든국민이 가진 공통점이 아니므로 제거(추상화)
	...
	// alt + s /상단메뉴 Source
	// Generate -> getter/setter 클릭

	// gender 의 getter/setter
